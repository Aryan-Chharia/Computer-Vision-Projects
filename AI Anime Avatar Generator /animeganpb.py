...
if __name__ == '__main__':
    model_folder = "/media/ada/0009B35A000DC852/a2/checkpoint/generator_model_weight"
    pb_save_path = "model.pb"
    freeze_graph(model_folder, pb_save_path)


    """ pb model 2 onnx command"""
    cmd = "python -m tf2onnx.convert --input Shinkai_53.pb --inputs generator_input:0  --outputs generator/G_MODEL/out_layer/Tanh:0  --output model.onnx"
    res = os.system(cmd)
    print(res)
